...
typedef struct
{
   ...
   // BB
   double        inflow_allinf;   // inflow rate after subtracting non gw limited inf
   double        BB_depth;
   double        BB_inflow;
   double        BB_runoff;
}  TSubarea;
...
typedef struct
{
   ...
   double        infilAvail;      // Infiltration before limiting by gwhead (ft/sec)
...
typedef struct
{
   double        Leak;        // groundwater > land surface from MF
